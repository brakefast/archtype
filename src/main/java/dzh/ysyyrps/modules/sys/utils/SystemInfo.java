...
public class SystemInfo {
	private static final String AUTH_MODULES_KEY="auth_moudles_key";
	private static final String SYSTEM_CACHE = "sysCache";
	...
	public List<Map> diskInfos(Sigar sigar) throws Exception {
		...
		for (int i = 0; i < fslist.length; i++) {
			Map<Object, Object> monitorMap = new HashMap<Object, Object>();
	...
	public static void setAuthModules(String authModules) {
		CacheUtils.put(SYSTEM_CACHE, AUTH_MODULES_KEY, authModules);
	}
	
	public static String getAuthModules() {
		Object object = CacheUtils.get(SYSTEM_CACHE, AUTH_MODULES_KEY);
