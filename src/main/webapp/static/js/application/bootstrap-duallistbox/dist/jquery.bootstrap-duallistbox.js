...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '总共 {0}条',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">结果集</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: '空值',                                                        // when there are no options present in the list
