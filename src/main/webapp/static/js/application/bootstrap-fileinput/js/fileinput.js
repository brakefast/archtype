...
(function (factory) {
    ...
    tCaption = '<div id="fileinput" tabindex="500" class="form-control file-caption {class}">\n' +
    ...
    $.fn.fileinput.defaults = {
        ...
        showCaption: true,
        showBrowse: true,
        showPreview: false, //change by ciocem
        showRemove: true,
        showUpload: true,
        showCancel: true,
        showClose: true,
        ...
        allowedFileTypes: ["png", "jpg", "bpmn", "bpmn20.xml"], //change by ciocem
        ...
        removeClass: 'btn btn-danger' +  //change by ciocem
        '',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn btn-info',  //change by ciocem
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        zoomModalHeight: 480,
        ...
        elErrorContainer: '#fileError',  //change by ciocem
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: '删除',
        removeTitle: '删除文件',  //change by ciocem
        cancelLabel: 'Cancel',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: '上传',
        uploadTitle: '上传文件',  //change by ciocem
        msgNo: 'No',
        msgNoFilesSelected: 'No files selected',
        msgCancelled: 'Cancelled',
        msgZoomModalHeading: '图片预览', //change by ciocem
